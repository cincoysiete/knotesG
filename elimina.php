...
?>
  ...
  <input type="checkbox" id="elimini" name="elimini" value="sí"><font size="2px" color="red">Eliminar nota completamente</font>

</form>
<br>
<font size="2px">Podrás ver y modificar las notas archivadas. Más adelante podrás recuperar la nota del archivo</font>
  </div>
</div>
