...
<div id="modal" class="modal">
  <div class="modal-contenido">
    ...
    <form method="post" action="buscando.php">
        <!-- <label for="texto_a_buscar">Texto a buscar:</label> -->
        <input type="text" id="texto_a_buscar" name="texto_a_buscar" id="nuevonombres" required>
        <!-- <button class="botonillo" type="submit">Buscar</button> -->
