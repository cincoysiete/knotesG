...
<div id="modal" class="modal">
  <div class="modal-contenido">
    ...
    <h2>Prescindir de colaboración</h2>
    <?php
$_SESSION["we"]=$_GET["we"];
...
?>
  <form action="quitaenviadono.php" method="post">
    <?php
echo "Vas a prescindir de la colaboración de <b>".$kaka[2]."</b> en tu nota <b>".$keke[0]."</b><br><br>";
    ?>
  <input type="submit" value="Prescindir de colaboración">
</form>
